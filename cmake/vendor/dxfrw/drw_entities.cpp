...
void DRW_Arc::parseCode(int code, dxfReader *reader){
    ...
    case 51:
        ...
        break;
//    case 60:
//        arcstartPoint.x = reader->getDouble();
//        break;
//    case 61:
//        arcstartPoint.y = reader->getDouble();
//        break;
//    case 62:
//        arcstartPoint.z = reader->getDouble();
//        break;

//    case 63:
//        arcendPoint.x = reader->getDouble();
//        break;
//    case 64:
//        arcendPoint.y = reader->getDouble();
//        break;
//    case 65:
//        arcendPoint.z = reader->getDouble();
//        break;
...
//    arcstartPoint.x = buf->getBitDouble();
//    arcstartPoint.y = buf->getBitDouble();
//    arcstartPoint.z = buf->getBitDouble();
//    DRW_DBG("arc start point: "); DRW_DBGPT(arcstartPoint.x, arcstartPoint.y, arcstartPoint.z);

//    arcendPoint.x = buf->getBitDouble();
//    arcendPoint.y = buf->getBitDouble();
//    arcendPoint.z = buf->getBitDouble();
//    DRW_DBG("arc end point: "); DRW_DBGPT(arcendPoint.x, arcendPoint.y, arcendPoint.z);
...
//    case 60: // arc start x
//        if (arc) arc->arcstartPoint.x = reader->getDouble();
//        break;
//    case 61: // arc start y
//        if (arc) arc->arcstartPoint.y = reader->getDouble();
//        break;
//    case 62: // arc start z
//        if (arc) arc->arcstartPoint.z = reader->getDouble();
//        break;

//    case 63: // arc end x
//        if (arc) arc->arcendPoint.x = reader->getDouble();
//        break;
//    case 64: // arc start y
//        if (arc) arc->arcendPoint.y = reader->getDouble();
//        break;
//    case 65: // arc start z
//        if (arc) arc->arcendPoint.z = reader->getDouble();
//        break;
...
//                    arc->arcstartPoint= buf->get2RawDouble();
//                    arc->arcendPoint= buf->get2RawDouble();
