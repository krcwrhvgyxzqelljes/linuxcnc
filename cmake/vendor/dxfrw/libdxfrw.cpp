...
//    writer->writeDouble(60, ent->arcstartPoint.x);
//    writer->writeDouble(61, ent->arcstartPoint.y);
//    writer->writeDouble(62, ent->arcstartPoint.z);

//    writer->writeDouble(63, ent->arcendPoint.x);
//    writer->writeDouble(64, ent->arcendPoint.y);
//    writer->writeDouble(65, ent->arcendPoint.z);
    return true;
}
            ...
            if ( (loop->type & 2) == 2){
                ...
                for (int j = 0; j<loop->numedges; ++j) {
                    ...
                    case DRW::ARC: {
                        ...
                        writer->writeDouble(30, a->basePoint.z);
...
//                        writer->writeDouble(60, a->arcstartPoint.x);
//                        writer->writeDouble(61, a->arcstartPoint.y);
//                        writer->writeDouble(62, a->arcstartPoint.z);
//                        writer->writeDouble(63, a->arcendPoint.x);
//                        writer->writeDouble(64, a->arcendPoint.y);
//                        writer->writeDouble(65, a->arcendPoint.z);
                        break; }
                    case DRW::ELLIPSE: {
