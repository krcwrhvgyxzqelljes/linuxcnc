...
public:
    ...
    // Test ve's
    void jog_position_master_endve(scurve_data &s, int enable, double endvel, double endacc, double tarpos, int jog_fwd, int jog_rev);
    int jog_position_fwd_endve(scurve_data &s, int enable, double tarpos);
    int jog_position_rev_endve(scurve_data &s, int enable, double tarpos);
    void jog_update_ve(scurve_data &s);

private:
    int jog_position_fwd(scurve_data &s, int status, double tarpos);
    int jog_position_rev(scurve_data &s, int status, double tarpos);
